def pals(pal='dos', form=0):
    ...
    def del_range(pal, *args):
        """Delete a range, or ranges, in the palette. Used to create palettes
        without action colors etc. Parameters are tuples."""
    ...
    if pal == 'dos':
        if form == 'raw':
            ...
            return del_range(dos_full, (1, 227), (255, 256))
        elif form == 'noact':
            return del_range(dos_full, (0, 1), (215, 255))
        else:
            return dos_full
    ...
    if pal == 'win':
        if form == 'raw':
            ...
            return del_range(win_full, (1, 217), (245, 256))
        elif form == 'noact':
            return del_range(win_full, (1, 10), (217, 245), (246, 255))
        else:
            return win_full
